...
// anthill
    ...
    ,anthill_scout_prob_default(mConfig["anthill"]["default scout prob"].toDouble())
    ,anthill_destroyed_texture (mConfig["anthill"]["destroyed texture"].toString())
...
//soldier  ants
    ...
    //scout  ants
    , ant_scout_hp(mConfig["ant"]["scout"]["hp"].toInt())
    , ant_scout_lifespan(mConfig["ant"]["scout"]["lifespan"].toInt())
    , ant_scout_strength(mConfig["ant"]["scout"]["strength"].toInt())
    , ant_scout_texture(mConfig["ant"]["scout"]["texture"].toString())

    //kamikaze  ants
    , ant_kamikaze_hp(mConfig["ant"]["kamikaze"]["hp"].toInt())
    , ant_kamikaze_lifespan(mConfig["ant"]["kamikaze"]["lifespan"].toInt())
    , ant_kamikaze_strength(mConfig["ant"]["kamikaze"]["strength"].toInt())
    , ant_kamikaze_texture(mConfig["ant"]["kamikaze"]["texture"].toString())
    , ant_kamikaze_explosionradius(mConfig["ant"]["kamikaze"]["explosion radius"].toDouble())
    , ant_kamikaze_explosionstrength (mConfig["ant"]["kamikaze"]["explosion strength"].toInt())
