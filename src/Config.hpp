...
public:
    ...
    const double anthill_scout_prob_default;
    const std::string anthill_destroyed_texture;
    ...
    //scout ants
    const int ant_scout_hp;
    const int ant_scout_lifespan;
    const int ant_scout_strength;
    const std::string ant_scout_texture;

    //kamikaze ants
    const int ant_kamikaze_hp;
    const int ant_kamikaze_lifespan;
    const int ant_kamikaze_strength;
    const std::string ant_kamikaze_texture;
    const double ant_kamikaze_explosionradius;
    const int ant_kamikaze_explosionstrength;
